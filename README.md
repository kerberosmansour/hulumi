...
> Hardened-by-default AWS, GitHub, Kubernetes, and Cloudflare edge infrastructure-as-code for [Pulumi](https://www.pulumi.com/). Apache-2.0. v1.5.3.
...
- [What's in the box](#whats-in-the-box-v153)
...
(If you already have `@pulumi/aws` or `@pulumi/pulumi` installed at any version in the same major line — `7.x` and `3.x` respectively — you don't need to change them. Hulumi 1.5.3 continues the caret-compatible Pulumi SDK peer-dependency posture introduced in 1.4.1.)
