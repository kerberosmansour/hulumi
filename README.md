...
| v1.5.7  | 2026-08-02 | Exact cluster-DNS security-group and NetworkPolicy routing for protected boundaries, plus Pod-template-only Istio injection opt-out that preserves the one-container admission contract. See [`docs/release/v1.5.7-release-notes.md`](./docs/release/v1.5.7-release-notes.md).                                                                                                                                                                                               |
