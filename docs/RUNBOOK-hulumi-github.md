...
| --- | ---------------------------------------------------------------------------------------------------------- | ------------- | ------- | --------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| 1   | `/hulumi-threat-model` GitHub scenarios + `@hulumi/baseline.github.SecureRepository` + sandbox-org E2E     | `not_started` |         |           | [docs/lessons/hulumi-github-m1.md](./lessons/hulumi-github-m1.md)         | [docs/completion/hulumi-github-m1.md](./completion/hulumi-github-m1.md)         |
| 2   | `@hulumi/baseline.github.OrgFoundation` + Code-Security-Configurations switchable backend                  | `not_started` |         |           | [docs/lessons/hulumi-github-m2.md](./lessons/hulumi-github-m2.md)         | [docs/completion/hulumi-github-m2.md](./completion/hulumi-github-m2.md)         |
| 3   | `@hulumi/policies.github.HulumiGithubHardeningPack` H1–H4 + `CisGithubV1Pack` + `G_OIDC_1`                 | `not_started` |         |           | [docs/lessons/hulumi-github-m3.md](./lessons/hulumi-github-m3.md)         | [docs/completion/hulumi-github-m3.md](./completion/hulumi-github-m3.md)         |
| 4   | `GithubWebhookFallbackAdapter` + verdict matrix (`tier-degraded`, `feature-not-licensed`) + adapter quorum | `not_started` |         |           | [docs/lessons/hulumi-github-m4.md](./lessons/hulumi-github-m4.md)         | [docs/completion/hulumi-github-m4.md](./completion/hulumi-github-m4.md)         |
| 5   | SLSA-L3 atomic-three-package release of GitHub additions + launch readiness (cookbooks, examples, docs)    | `not_started` |         |           | [docs/lessons/hulumi-github-m5.md](./lessons/hulumi-github-m5.md)         | [docs/completion/hulumi-github-m5.md](./completion/hulumi-github-m5.md)         |
...
(Filled by Step 3 — final review — once all five milestone files are written.)
...
- [M1: `/hulumi-threat-model` GitHub scenarios + `SecureRepository` + sandbox-org E2E](./runbook-milestones/hulumi-github-m1.md) — *not yet written*
- [M2: `OrgFoundation` + Code-Security-Configurations switchable backend](./runbook-milestones/hulumi-github-m2.md) — *not yet written*
- [M3: `HulumiGithubHardeningPack` + `CisGithubV1Pack` + `G_OIDC_1`](./runbook-milestones/hulumi-github-m3.md) — *not yet written*
- [M4: `GithubWebhookFallbackAdapter` + verdict matrix extension](./runbook-milestones/hulumi-github-m4.md) — *not yet written*
- [M5: SLSA-L3 release + launch readiness](./runbook-milestones/hulumi-github-m5.md) — *not yet written*

Lessons learned: [`docs/lessons/hulumi-github-m{1..5}.md`](./lessons/) — *not yet written*. Completion summaries: [`docs/completion/hulumi-github-m{1..5}.md`](./completion/) — *not yet written*.
