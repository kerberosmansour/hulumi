...
| 5   | `GitHubAppCredential` + shipped scripts + atomic four-package release of K8s package alongside the existing three (closes #43) | `not_started` |         |           | [docs/lessons/hulumi-k8s-m5.md](./lessons/hulumi-k8s-m5.md) | [docs/completion/hulumi-k8s-m5.md](./completion/hulumi-k8s-m5.md) |
