...
**Source**: [docs/slo/lessons/hulumi-m4.md](./slo/lessons/hulumi-m4.md) line 14; observed in this doc pass.
...
**Source**: [docs/slo/lessons/hulumi-m1.md](./slo/lessons/hulumi-m1.md) lines 49–50.
...
**Source**: This doc pass; the same gotchas appear across [docs/slo/lessons/](./slo/lessons/) and [docs/development.md § Common gotchas](./development.md#common-gotchas).
...
**Source**: [docs/slo/lessons/hulumi-m4.md](./slo/lessons/hulumi-m4.md) line 61.
...
**Source**: [docs/slo/lessons/hulumi-m4.md](./slo/lessons/hulumi-m4.md) line 62.
...
**Source**: [docs/slo/lessons/hulumi-m4.md](./slo/lessons/hulumi-m4.md) line 60.
...
**Source**: [docs/slo/lessons/hulumi-m2.md](./slo/lessons/hulumi-m2.md) line 41; [CHANGELOG.md § Deprecated](../CHANGELOG.md).
...
**Source**: [docs/slo/lessons/hulumi-m3.md](./slo/lessons/hulumi-m3.md) (referenced in lessons); [docs/integration-testing.md](./integration-testing.md).
...
**Source**: [docs/slo/lessons/hulumi-m4.md](./slo/lessons/hulumi-m4.md) line 78.
...
**Source**: [docs/slo/lessons/hulumi-m5.md](./slo/lessons/hulumi-m5.md) line 63.
...
**Source**: [docs/slo/lessons/hulumi-m4.md](./slo/lessons/hulumi-m4.md) lines 67, 70.
...
**Source**: [docs/slo/lessons/hulumi-m3.md](./slo/lessons/hulumi-m3.md); [docs/components/account-foundation.md](./components/account-foundation.md) lines 144–146.
...
**Source**: [docs/slo/lessons/hulumi-m5.md](./slo/lessons/hulumi-m5.md) line 64.
...
**Source**: [docs/slo/lessons/hulumi-m1.md](./slo/lessons/hulumi-m1.md) line 32; same observation in M3 and M4 lessons.
...
- Hulumi runbooks under `docs/slo/runbook-milestones/` are NOT touched (they're frozen by milestone).
...
**Source**: [docs/slo/lessons/hulumi-m4.md](./slo/lessons/hulumi-m4.md) line 79; used in M3 + M4.
...
**Labels**: `meta`, `roadmap`
**Source**: [docs/slo/lessons/hulumi-m5.md](./slo/lessons/hulumi-m5.md) lines 67–68.
...
**The cross-cutting design decisions live in [`docs/slo/design/hulumi-k8s-surface.md`](./slo/design/hulumi-k8s-surface.md)** (authored 2026-04-26). That doc commits to the package layout, the `HardenedHelmRelease` wrapper shape, the version-pin policy, the PSA-baseline default, the mesh-choice rationale (Istio first), and the per-component API shape. Read it before opening implementation PRs against any of #38–#44.

The list also seeds a v1.x AWS-side deferral track parallel to the existing GitHub-side [`hulumi-github-v1.1-deferrals.md`](./slo/runbook-milestones/hulumi-github-v1.1-deferrals.md). When the maintainer is ready to commit to a Kubernetes surface, fork that doc shape (trigger condition + acceptance criteria + target milestone per item) into `docs/slo/runbook-milestones/hulumi-aws-k8s-deferrals.md`.
...
Sequencing committed in [`docs/slo/design/hulumi-k8s-surface.md` § Sequencing](./slo/design/hulumi-k8s-surface.md#sequencing-when-this-doc-is-accepted):
