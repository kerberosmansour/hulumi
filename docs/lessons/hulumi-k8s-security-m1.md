...
- **Did NOT bump K8s package version off `1.0.0-pre.1`** — runbook §6.7 forbids bundling release work into M1. The four-package atomic release path is now ready; the actual version bump and tag belong to a separate launch PR (foreshadowed in `docs/lessons/hulumi-k8s-m5.md`).
