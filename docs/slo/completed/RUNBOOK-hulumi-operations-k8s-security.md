...
> **Prerequisite reading**: `README.md`, `docs/ARCHITECTURE.md`, `docs/slo/completed/RUNBOOK-hulumi-k8s.md`, `docs/slo/completed/RUNBOOK-hulumi-operations.md`, `docs/slo/design/hulumi-k8s-surface.md`, `docs/slo/design/hulumi-for-operations.md`, `docs/slo/design/hulumi-for-operations-threat-model.md`, `hulumi-k8s-security-improvement-report.md`, `packages/baseline/src/aws/*`, `packages/k8s-baseline/src/*`, `packages/policies/src/*`, `packages/drift/src/*`, `skills/hulumi-threat-model/SKILL.md`.
...
| --- | -------------------------------------------------------------------- | ------ | ---------- | ---------- | -------------------------------------------- | ----------------------------------------------- |
| 1   | Ship-ready K8s package, docs, release path, and integration skeleton | `done` | 2026-05-01 | 2026-05-01 | `docs/slo/lessons/hulumi-k8s-security-m1.md` | `docs/slo/completion/hulumi-k8s-security-m1.md` |
| 2   | Close unsafe defaults in current K8s primitives                      | `done` | 2026-05-01 | 2026-05-01 | `docs/slo/lessons/hulumi-k8s-security-m2.md` | `docs/slo/completion/hulumi-k8s-security-m2.md` |
| 3   | K8s and EKS CrossGuard hardening packs                               | `done` | 2026-05-01 | 2026-05-01 | `docs/slo/lessons/hulumi-k8s-security-m3.md` | `docs/slo/completion/hulumi-k8s-security-m3.md` |
| 4   | Namespace and network security foundations                           | `done` | 2026-05-01 | 2026-05-01 | `docs/slo/lessons/hulumi-k8s-security-m4.md` | `docs/slo/completion/hulumi-k8s-security-m4.md` |
| 5   | EKS detection and disaster recovery foundations                      | `done` | 2026-05-01 | 2026-05-01 | `docs/slo/lessons/hulumi-k8s-security-m5.md` | `docs/slo/completion/hulumi-k8s-security-m5.md` |
| 6   | EKS upgrade, add-on, drift, and threat-model expansion               | `done` | 2026-05-01 | 2026-05-01 | `docs/slo/lessons/hulumi-k8s-security-m6.md` | `docs/slo/completion/hulumi-k8s-security-m6.md` |
| 7   | Ops M1: `Ec2PatchBaseline` + `Ec2PatchWaves`                         | `done` | 2026-05-01 | 2026-05-01 | `docs/slo/lessons/hulumi-operations-m1.md`   | `docs/slo/completion/hulumi-operations-m1.md`   |
| 8   | Ops M2: `DetectiveServicesEnable`                                    | `done` | 2026-05-01 | 2026-05-01 | `docs/slo/lessons/hulumi-operations-m2.md`   | `docs/slo/completion/hulumi-operations-m2.md`   |
| 9   | Ops M3: `AuditTrail` + `IdentityAlarms` extension                    | `done` | 2026-05-01 | 2026-05-01 | `docs/slo/lessons/hulumi-operations-m3.md`   | `docs/slo/completion/hulumi-operations-m3.md`   |
| 10  | Ops M4: `HulumiOperationsHardeningPack`                              | `done` | 2026-05-01 | 2026-05-01 | `docs/slo/lessons/hulumi-operations-m4.md`   | `docs/slo/completion/hulumi-operations-m4.md`   |
| 11  | Ops M5: threat-model ops scenarios + atomic four-package release     | `done` | 2026-05-01 | 2026-05-01 | `docs/slo/lessons/hulumi-operations-m5.md`   | `docs/slo/completion/hulumi-operations-m5.md`   |
...
Path: `docs/slo/lessons/hulumi-k8s-security-m<N>.md`
...
Path: `docs/slo/completion/hulumi-k8s-security-m<N>.md`
...
| Files to read before changing anything | all allowed files, `docs/slo/completed/RUNBOOK-hulumi-k8s.md`, `packages/k8s-baseline/src/compatibility.ts`                                                                                                                                                                                                                          |
...
- See `docs/slo/lessons/hulumi-k8s-security-m1.md` and `docs/slo/completion/hulumi-k8s-security-m1.md`.
...
Parent runbook: [docs/slo/completed/RUNBOOK-hulumi-operations.md](../RUNBOOK-hulumi-operations.md). Read the runbook's **Carmack-Style Best Practices**, the Global Execution Rules (especially **Rule 0** - the Hulumi-Operations scope contract, **Rule 8** - tier defaults must encode the breach risk, **Rule 10** - `MonitoringFoundation` is the only SNS topic this runbook touches, and **Rules 11-14** - the v4 assertions/bounds/static-analysis/debugger discipline) + the Global Entry Rules before starting.
...
2. No `docs/slo/lessons/hulumi-operations-m0.md` exists. Skip "read prior lessons" with a note in the Evidence Log.
...
| `docs/slo/completed/RUNBOOK-hulumi-operations.md` Milestone Tracker              | MODIFY: M1 row -> `in_progress` on start, `done` on exit                                                                                                                                                                                                                    |
| `docs/slo/runbook-milestones/hulumi-operations-m1.md`                            | MODIFY (during execution only): fill Evidence Log rows                                                                                                                                                                                                                      |
| `docs/slo/lessons/hulumi-operations-m1.md`                                       | NEW (during exit): per the v4 lessons template                                                                                                                                                                                                                              |
| `docs/slo/completion/hulumi-operations-m1.md`                                    | NEW (during exit): per the v4 completion template                                                                                                                                                                                                                           |
...
- `docs/slo/lessons/hulumi-operations-m1.md` written per the v4 lessons template (incl. assumptions verified / unresolved, invariants added, resource bounds, debugging notes).
- `docs/slo/completion/hulumi-operations-m1.md` written per the v4 completion template.
- Milestone Tracker in [`docs/slo/completed/RUNBOOK-hulumi-operations.md`](../RUNBOOK-hulumi-operations.md) updated to `done`.

#### Post-Flight

- **`docs/slo/completed/RUNBOOK-hulumi-operations.md`** Milestone Tracker -> M1 `done`.
- **`docs/slo/completed/RUNBOOK-hulumi-operations.md` Component Summary Table** - verify M1 row matches what was actually shipped.
...
Parent runbook: [docs/slo/completed/RUNBOOK-hulumi-operations.md](../RUNBOOK-hulumi-operations.md). Read the **Carmack-Style Best Practices**, the Global Execution Rules (especially **Rule 0**, **Rule 9** - routing required at StartupHardened, **Rule 10** - no new SNS topics, and **Rules 11-14**) + the Global Entry Rules + `docs/slo/lessons/hulumi-operations-m1.md` before starting.
...
| Files allowed to change                            | NEW: `packages/baseline/src/aws/detective-services-enable.{ts,args.ts,outputs.ts}`, `packages/baseline/tests/aws/detective-services-enable.test.ts`, `packages/baseline/tests/integration/aws-ops/detective-services-enable.aws-ops.test.ts`, `docs/components/detective-services-enable.md` (one-line stub), `docs/slo/lessons/hulumi-operations-m2.md`, `docs/slo/completion/hulumi-operations-m2.md`. MODIFIED: `packages/baseline/src/aws/index.ts` (re-exports), `docs/slo/completed/RUNBOOK-hulumi-operations.md` Milestone Tracker, `docs/slo/runbook-milestones/hulumi-operations-m2.md` (this file - Evidence Log only), `docs/ARCHITECTURE.md` (one paragraph), `docs/issue-candidates.md` (strike #49). REFUSE TO TOUCH: `Ec2PatchBaseline` files (M1), all `AuditTrail` files (M3), `packages/policies/`, `packages/drift/`, `packages/k8s-baseline/`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Files to read before changing anything             | `docs/slo/completed/RUNBOOK-hulumi-operations.md` (Global Execution Rules + this milestone); `docs/slo/design/hulumi-for-operations.md` section Decision: `DetectiveServicesEnable` shape; `docs/slo/design/hulumi-for-operations-threat-model.md` `DetectiveServicesEnable` STRIDE rows; `docs/slo/lessons/hulumi-operations-m1.md` (apply corrections); `packages/baseline/src/aws/ec2-patch-baseline.ts` (M1 pattern precedent - same `pulumi.ComponentResource` discipline); `packages/baseline/src/aws/monitoring-foundation.ts`; `packages/baseline/src/aws/identity-alarms.ts`; the verbatim text of [#49](https://github.com/kerberosmansour/hulumi/issues/49) (the proposal we're implementing).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
2. Read `docs/slo/lessons/hulumi-operations-m1.md` and apply any corrections (especially around `Tier`-enum usage and the M1-established `pulumi.ComponentResource` constructor pattern).
...
| `docs/slo/completed/RUNBOOK-hulumi-operations.md` Milestone Tracker                     | MODIFY: M2 `in_progress` -> `done`                                                                |
| `docs/slo/runbook-milestones/hulumi-operations-m2.md`                                   | MODIFY: Evidence Log fill-in                                                                      |
| `docs/slo/lessons/hulumi-operations-m2.md`                                              | NEW per v4 lessons template                                                                       |
| `docs/slo/completion/hulumi-operations-m2.md`                                           | NEW per v4 completion template                                                                    |
...
- `docs/slo/completed/RUNBOOK-hulumi-operations.md` Milestone Tracker -> M2 `done`.
...
- **NEW 2026-05-01 per Flaw 1**: the **dual-route + KEV-native-via-Inspector-v2** is the second load-bearing decision. The KEV-route is _not_ an opaque Hulumi-shipped Lambda joining external feeds - it's an EventBridge rule with the JSON pattern `{"source":["aws.inspector2"], "detail-type":["Inspector2 Finding"], "detail":{"findingDetails":{"kev":{"dateAdded":[{"exists":true}]}}}}`. The lessons file should record (a) the prior speculation about Step Functions / cisa.gov fetch was unnecessary because Inspector v2 already surfaces KEV inline since 2023, and (b) the runbook design saved a milestone of effort by checking AWS docs first.
...
**Important design rule**: **The S3 bucket is created via `SecureBucket`** - not `aws.s3.BucketV2`. This is the load-bearing decision M3 ships. `SecureBucket` already enforces TLS-only, public-access-block, SSE-KMS, versioning - the bucket-publicread-via-policy abuse case (`tm-hulumi-ops-abuse-bucket-publicread-bpb`) is eliminated _by construction_ because the BPB rejects any policy that grants `Principal: "*"` regardless of how the policy was added. The CloudTrail-write policy on the bucket is added as a separate `aws.s3.BucketPolicy` whose construction depends on the trail ARN being known (Pulumi standard `Output<>` chain handles ordering). Critically: this means M3 is the first runbook in the project where one Hulumi component (`AuditTrail`) consumes another Hulumi component (`SecureBucket`) directly - not via re-export, but via internal use. Document this pattern explicitly in the lessons file.
...
Parent runbook: [docs/slo/completed/RUNBOOK-hulumi-operations.md](../RUNBOOK-hulumi-operations.md). Read **Carmack-Style Best Practices**, the Global Execution Rules (especially **Rule 0** + **Rules 11-14**) + the Global Entry Rules + `docs/slo/lessons/hulumi-operations-m{1,2,3}.md` before starting.
...
Parent runbook: [docs/slo/completed/RUNBOOK-hulumi-operations.md](../RUNBOOK-hulumi-operations.md). Read **Carmack-Style Best Practices**, the Global Execution Rules + Global Entry Rules + `docs/slo/lessons/hulumi-operations-m{1,2,3,4}.md` before starting.
...
| `docs/slo/completed/RUNBOOK-hulumi-operations.md`                          | MODIFY: Milestone Tracker -> M5 `done`, Documentation Update Table final fill-in                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `docs/slo/runbook-milestones/hulumi-operations-m5.md`                      | MODIFY: Evidence Log fill-in                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `docs/slo/lessons/hulumi-operations-m5.md`                                 | NEW per v4 lessons template                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `docs/slo/completion/hulumi-operations-m5.md`                              | NEW per v4 completion template                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
- `docs/slo/completed/RUNBOOK-hulumi-operations.md` Milestone Tracker -> M5 `done`. Documentation Update Table -> final fill-in.
...
- The Operations surface is a _minor_ version bump, not a major one, because every change is additive. The existing v1.1.x consumer who upgrades to 1.2.0 sees zero behavior change for their existing components.
...
- `~/Dev/GitHub/SunLitOrchestrate/docs/templates/runbook-template_v_4_template.md`
- `~/Documents/Codex/2026-05-01/look-at-this-project-called-hulumi/hulumi-k8s-security-improvement-report.md`
- `~/Dev/GitHub/Hulumi/README.md`
- `~/Dev/GitHub/Hulumi/docs/slo/completed/RUNBOOK-hulumi-k8s.md`
- `~/Dev/GitHub/Hulumi/docs/slo/completed/RUNBOOK-hulumi-operations.md`
- `~/Dev/GitHub/Hulumi/docs/slo/runbook-milestones/hulumi-operations-m1.md`
- `~/Dev/GitHub/Hulumi/docs/slo/runbook-milestones/hulumi-operations-m2.md`
- `~/Dev/GitHub/Hulumi/docs/slo/runbook-milestones/hulumi-operations-m3.md`
- `~/Dev/GitHub/Hulumi/docs/slo/runbook-milestones/hulumi-operations-m4.md`
- `~/Dev/GitHub/Hulumi/docs/slo/runbook-milestones/hulumi-operations-m5.md`
- `~/Dev/GitHub/Hulumi/docs/slo/design/hulumi-k8s-surface.md`
- `~/Dev/GitHub/Hulumi/packages/baseline/src/aws/*`
- `~/Dev/GitHub/Hulumi/packages/baseline/tests/aws/*`
- `~/Dev/GitHub/Hulumi/packages/k8s-baseline/src/*`
- `~/Dev/GitHub/Hulumi/packages/k8s-baseline/tests/*`
- `~/Dev/GitHub/Hulumi/packages/policies/src/*`
- `~/Dev/GitHub/Hulumi/packages/drift/src/*`
- `~/Dev/GitHub/Hulumi/skills/hulumi-threat-model/*`
