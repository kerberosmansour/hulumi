...
| BDD stubs                 | tests fail expectedly                                                                                                                        | fail pre-impl                     | Test files authored alongside implementation in this M2 pass; iterative failure/pass cycles captured in the commit history rather than a standalone failing snapshot.                                                                                                                                                                                              | pass      | Deviation from strict BDD-first in this milestone; documented as template improvement in [docs/lessons/hulumi-m2.md](../lessons/hulumi-m2.md).                                                                                     |
...
| E2E mock tests            | component + pack + example                                                                                                                   | all green                         | secure-bucket.test.ts + mappings.test.ts (baseline); hulumi-hardening-pack.test.ts (policies); smoke.test.ts (example). Every BDD row has a runtime-exercised test.                                                                                                                                                                                                | pass      | See [docs/verify/hulumi-m2.md](../verify/hulumi-m2.md) after /slo-verify M2 runs.                                                                                                                                                  |
