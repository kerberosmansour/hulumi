...
| Files to read before changing | [interfaces.md §1](../design/hulumi/interfaces.md), [ARCHITECTURE.md](../design/hulumi/ARCHITECTURE.md), [critique §§C2, E3, E7](../critique/hulumi.md), `docs/slo/lessons/hulumi-m{1,2}.md`, [AWS Security Hub CIS v5](https://aws.amazon.com/about-aws/whats-new/2025/10/aws-security-hub-cspm-cis-foundations-benchmark-v5/), [GuardDuty API](https://docs.aws.amazon.com/AmazonGuardDuty/latest/APIReference/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
2. Read `docs/slo/lessons/hulumi-m2.md`; apply corrections.
...
- `docs/slo/lessons/hulumi-m3.md` + `docs/slo/completion/hulumi-m3.md` written.
